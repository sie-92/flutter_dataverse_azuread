...
final accountsUrl = webapiurl +
    "accounts?\$select=accountnumber,statecode,emailaddress1,name,address1_country,address1_stateorprovince,address1_composite,websiteurl";

final clientId = 'e4f8c303-0de4-48eb-81e6-a58c9b10a287';
final azureTenantId = "343f1998-02b9-416b-a60f-1b3bc14717c4";
var authorizationEndpoint = Uri.parse("https://login.microsoftonline.com/" +
    azureTenantId +
...
class Repository {
  ...
  Future< /*String */ List<Account>> fetchAccounts() async {
    ...
    if (response.statusCode == 200) {
      return compute(
          parseAccount, json.encode(json.decode(response.body)["value"]));
    } else {
      //print(response.body);
